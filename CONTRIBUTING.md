# Contributing to zetz-mode

Hi there! Thanks for your interest in contributing to `zetz-mode`.

Please note, that by submitting changes to `zetz-mode`, you are agreeing that
it can be licensed under our license as seen in `zetz-mode.el`. Furthermore,
you are testifying that you own the copyright to the submitted changes and
indemnify `zetz-mode` from any copyright claim that might result from your not
